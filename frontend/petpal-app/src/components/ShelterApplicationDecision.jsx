...
const ShelterApplicationDecision = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const endpoint = `http://127.0.0.1:8000/applications/${userId}/${appId}/shelter/alteration/`;
        ...
        <div className="container col-xl-10 col-xxl-8 px-4 py-5">
            <div className="center-form form-box">
                ...
                <form className="form-container" encType="multipart/form-data" onSubmit={handleSubmit}>
                    ...
                    <button style={{ marginBottom: "10px", marginRight: "5px" }} type="submit" className="btn btn-primary" onClick={handleAccept}>Accept</button>
                    <button style={{ marginBottom: "10px" }} type="submit" className="btn btn-primary" onClick={handleRejection}>Reject</button>
...
export default ShelterApplicationDecision;