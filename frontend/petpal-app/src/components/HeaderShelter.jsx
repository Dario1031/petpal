    ...
    <nav className="navbar navbar-expand-lg custom-navbar">
        <div className="container-fluid">
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <Link className="nav-link" aria-current="page" to ="/shelterpets">My Pets</Link>
                </li>
                <li className="nav-item">
                <Link className="nav-link" aria-current="page" to ="/petcreation">Add New Pet</Link>
                </li>
                <li className="nav-item">
                ...
                {/* <li className="nav-item">
                <Link className="nav-link" aria-current="page" to ="/applications">Applications</Link>
                </li> */}
                <li className="nav-item">
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-lg-center row-gap-3">
              ...
              {user.profile_img && (
                ...
                <ul className="dropdown-menu text-small dropdown-menu-end mx-lg-2">
                    ...
                    {/* <li><a className="dropdown-item" href="shelter_account_edit_page.html">Edit Profile</a></li> */}
